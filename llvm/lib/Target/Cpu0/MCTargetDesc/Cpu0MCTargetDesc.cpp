...
static MCRegisterInfo *createCpu0MCRegsiterInfo(const Triple &TT) {
...
static MCSubtargetInfo *createCpu0MCSubtargetInfo(const Triple &TT,
  ...
  return createCpu0MCSubtargetInfoImpl(TT, CPU, "", StringRef(ArchFS));
...
extern "C" void LLVMInitializeCpu0TargetMC() {
  ...
  for (Target *T : {&TheCpu0Target, &TheCpu0elTarget}) {
    ...
    TargetRegistry::RegisterMCRegInfo(*T, createCpu0MCRegsiterInfo);
